/* ============================================================
   ...
   Réconcilié contre BRIEF_cockpit_v3_clean.md / SPEC v1.0
...
const FUND = {
  ...
  /* Ratios de structure (hors covenants bancaires) :
     ...
     levier AIFM en approche simplifiée GAV/NAV (plafond prospectus). */
  ratios: {
...
/* Scénario Bear (brief §D) : loyers −10 %, vacance +400 bps,
   cap rates +125 bps, taux +150 bps. */
const BEAR = { rent: -0.10, vac: 0.04, cap: 0.0125, rate: 0.015 };

/* Configuration des sliders de stress (spec §5.1).
...
/* Flux mensuels consolidés — encaissements locatifs nets (€m),
   24 mois glissants : avril 2024 → mars 2026 (spec §3.5).
...
const TREASURY = {
  ...
  distributionAmount: 3.5                    // ~95 % du cash-flow distribuable annuel
};
